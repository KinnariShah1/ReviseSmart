...
export async function POST(req: Request, res: Response) {
    try {
        ...
        const image_search_term = "mathematics beauty calculus";
        const course_image = await getUnsplashImage(
            "mathematics beauty calculus"
        );

        // console.log("Course image from Unsplash API:", course_image);
